...
class TestRotations(amusetest.TestCase):
    ...
    def test10(self):
        ...
        self.assertAlmostEqual(dot1,dot2,14)
        self.assertAlmostEqual(cross2,cross1.dot(numpy.linalg.inv(rm)),14)
    ...
    def test11(self):
        ...
        self.assertAlmostEqual(dot1.value_in(units.km**2/units.s),dot2.value_in(units.km**2/units.s),14)
        self.assertAlmostEqual(cross2.value_in(units.km**2/units.s),cross1.dot(numpy.linalg.inv(rm)).value_in(units.km**2/units.s),13)
